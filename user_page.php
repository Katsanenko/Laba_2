...
<form action="update_ex_user.php" method="POST" enctype="multipart/form-data">
...
<?php 
    echo '<a href="' . htmlspecialchars("delete_user.php?id=" . urlencode($currentUser)) . '" class="btn btn-danger">'. "Delete this user" . '</a>';
?>
    <br><br><a href="main_adm.php" class="btn btn-primary">Вернуться</a>
</body>
</html>